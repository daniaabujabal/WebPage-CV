    ...
    <section class="page-heading">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>Contact Us</h1>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque similique velit culpa dolorem iusto laudantium ipsum necessitatibus nulla iste. Fugit est tenetur tempore eos voluptatem. Facere hic maxime maiores eligendi.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="section-heading contact-info">
                        <h2>Contact Info</h2>
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Consequuntur porro aperiam autem saepe non ex vel, iste accusantium, nisi corrupti enim. Assumenda illo porro officiis dolores nisi quibusdam numquam eveniet. <br>Between The 6th and The 5th Circle <br>Suleiman AlHadidi Street</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="video">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div id="video">
        <video width="1080px" height="500px" controls>
